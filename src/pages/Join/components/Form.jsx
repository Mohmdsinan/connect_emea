...
const communities = ["IEDC", "NSS", "NCC", "Union", "Other", "None"];
    ...
    <>
      <Form {...form} className="min-w-full">
        ...
        >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem ref={parent}>
                ...
                <FormControl>
                  <Textarea
                    placeholder="How did you hear about Connect?"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
          ...
          />
          <div
            className="space-y-4 md:space-y-0 md:gap-x-8 md:gap-y-4 grid md:grid-cols-2"
            ref={parent}
          >
            <FormField
              control={form.control}
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectGroup>
                          ...
                          <SelectItem value="Tech intern">
                            Tech intern
                          </SelectItem>
                          <SelectItem value="Community manager">
                            Community manager
                          </SelectItem>
                          <SelectItem value="Video editor/photographer">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem ref={parent}>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="Tell us what role you're interested in"
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
