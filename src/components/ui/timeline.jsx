  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto pt-10 px-4 md:px-8 lg:px-10">
        <h2 className="max-w-[600px] font-semibold text-[25px] sm:text-[38px] text-center  mx-auto">
          Your future, with friends by <span className="text-orange-500" >your side.</span>
        </h2>
      </div>
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-orange-300 dark:bg-neutral-800 border border-orange-400 dark:border-neutral-700 p-2" />
              </div>
